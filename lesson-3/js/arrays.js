...
myArray[3][1] = true;
console.log(`The 2nd element of the array is ${myArray[3][1]}.`)
...
let orig6 = "Toronto Maple Leafs, Chicago Black Hawks, Detroit Red Wings, Boston Bruins, Montrèal Canadiens, New York Rangers";
...
let numItems = orig6Array.push("Buffalo Sabers", "New York Islanders");
...
numItems = orig6Array.unshift("Winnipeg Jets", "Quèbec Nordique");
...
orig6Array.splice(3, 0, "Edmonton Oilers", "Florida Panthers");
